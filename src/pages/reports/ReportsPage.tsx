...
interface PlotProductionReportItem {
    id: string;
    name: string | null;
    crop: string | null;
    cost: number;
        ...
        try {
            switch (reportType) {
                ...
                case 'plot_production': {
                    ...
                    if (error) throw error;
                    const reportData: PlotProductionReportItem[] = (data as Plot[] || []).map((plot: Plot) => {
                    ...
                    const columns: Column<PlotProductionReportItem>[] = [
                ...
                case 'active_employees': {
                    ...
                    setReportContent(<DataTable columns={employeeColumns} data={data as ActiveEmployeeReportItem[]} />);
                    setReportDataForExport(data as ActiveEmployeeReportItem[]);
                    setReportColumnsForExport(employeeColumns);
