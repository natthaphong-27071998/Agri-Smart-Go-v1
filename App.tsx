...
const ProtectedLayout: React.FC = () => {
    ...
    return (
        <div id="app-container" className="flex h-screen bg-gray-200 dark:bg-black">
            <Sidebar companyInfo={companyInfo} userProfile={userProfile} onLogout={handleLogout} />
            <div id="content-wrapper" className="flex-1 flex flex-col overflow-hidden">
                ...
                <main className="flex-1 overflow-x-hidden overflow-y-auto bg-gray-100 dark:bg-gray-900 p-6">
                    <Routes>
                        ...
                        <Route path="/admin" element={<AdminPage companyInfo={companyInfo} setCompanyInfo={setCompanyInfo} />} />
