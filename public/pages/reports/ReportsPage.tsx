        ...
        try {
            switch (reportType) {
                ...
                case 'active_employees': {
                    ...
                    const reportData = data as ActiveEmployeeReportItem[];
                    setReportContent(<DataTable columns={employeeColumns} data={reportData} />);
                    setReportDataForExport(reportData); setReportColumnsForExport(employeeColumns); setIsExportable(true);
                    break;
                }
