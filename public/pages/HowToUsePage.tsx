            ...
            <main className="container mx-auto px-6 py-12">
                ...
                <div className="max-w-4xl mx-auto mb-10">
                    <div className="bg-blue-50 border-l-4 border-blue-500 p-6 rounded-r-lg shadow-md">
                        <div className="flex items-center">
                            ...
                            <Link to="/setup" className="ml-auto px-4 py-2 bg-blue-600 text-white font-semibold rounded-md hover:bg-blue-700 whitespace-nowrap transition-transform transform hover:scale-105">
                                ไปที่หน้าตั้งค่า
                            </Link>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
                    ...
                    <FeatureGuideCard
                        ...
                        description="สร้างใบเสนอราคา, จัดการคำสั่งซื้อของลูกค้า, ดูข้อมูลลูกค้า (CRM), และติดตามสินค้าคงคลัง พร้อมออกใบเสนอราคาและใบแจ้งหนี้"
                    />
                     <FeatureGuideCard
                 ...
                 <div className="text-center mt-16 space-y-6">
                    <Link to="/login" className="px-10 py-4 bg-green-500 text-white font-bold rounded-full hover:bg-green-400 transition-transform duration-300 transform hover:scale-105 text-lg shadow-lg inline-block">
                        เริ่มจัดการฟาร์มของคุณ
                    </Link>
                    <div>
                        <Link to="/" className="text-sm font-medium text-gray-600 hover:text-green-500 dark:text-gray-400 dark:hover:text-green-300 transition-colors">
