...
const DatabaseSetupPage: React.FC = () => {
    ...
    return (
        <div className="bg-white dark:bg-gray-800 p-6 md:p-8 rounded-lg shadow-lg m-4 text-gray-800 dark:text-gray-200">
            <h2 className="text-2xl font-bold mb-2">สคริปต์สำหรับตั้งค่าฐานข้อมูล (Database Setup Script)</h2>
            <p className="text-gray-600 dark:text-gray-400 mb-6">กรุณาทำตามขั้นตอนทั้งหมดเพื่อตั้งค่าฐานข้อมูลและผู้ใช้งานสำหรับแอปพลิเคชัน</p>

            <div className="bg-yellow-50 dark:bg-yellow-900/30 border-l-4 border-yellow-400 p-4 rounded-r-lg mb-8">
                <div className="flex">
                    <div className="py-1">
                        <svg className="fill-current h-6 w-6 text-yellow-500 mr-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M2.93 17.07A10 10 0 1 1 17.07 2.93 10 10 0 0 1 2.93 17.07zM9 11v4h2v-4H9zm0-4h2v2H9V7z"/></svg>
                    </div>
                    <div>
                        <p className="font-bold text-yellow-800 dark:text-yellow-200">สำคัญมาก</p>
                        <p className="text-sm text-yellow-700 dark:text-yellow-300">ต้องทำทั้ง 3 ขั้นตอนตามลำดับ สคริปต์นี้สามารถรันซ้ำได้โดยไม่เกิดข้อผิดพลาด</p>
                    </div>
                </div>
            </div>
            ...
            <div className="space-y-8">
                <div>
                    <h3 className="text-xl font-semibold border-b-2 border-green-500 pb-2 mb-4">ขั้นตอนที่ 1: สร้างผู้ใช้งานสำหรับล็อกอิน (Authentication User)</h3>
                    ...
                    <ol className="list-decimal list-inside text-gray-700 dark:text-gray-300 space-y-2">
                        <li>ไปที่หน้าโปรเจกต์ Supabase ของคุณ และเลือกเมนู <code className="bg-gray-200 dark:bg-gray-700 px-1.5 py-0.5 rounded">Authentication</code> จากเมนูด้านซ้าย</li>
                        ...
                        <li>ในช่อง Password, กรอกรหัสผ่านที่คุณต้องการใช้ (สำหรับทดลอง, ใช้: <code className="bg-gray-200 dark:bg-gray-700 px-1.5 py-0.5 rounded">123456</code>)</li>
                        <li>**(สำคัญ)** ปิดสวิตช์ <code className="bg-gray-200 dark:bg-gray-700 px-1.5 py-0.5 rounded">Enable email confirmation</code> เพื่อให้สามารถล็อกอินได้ทันที</li>
                        <li>คลิกปุ่ม <code className="bg-green-200 dark:bg-green-700 px-1.5 py-0.5 rounded text-green-800 dark:text-green-100 font-bold">Add user</code> เพื่อสร้างผู้ใช้</li>
                    </ol>
                </div>

                <div>
                    <h3 className="text-xl font-semibold border-b-2 border-green-500 pb-2 mb-4">ขั้นตอนที่ 2: สร้างตารางและข้อมูล (SQL Script)</h3>
                    ...
                    <div className="relative">
                        <button 
                            onClick={handleCopy}
                            className="absolute top-3 right-3 px-3 py-1 bg-gray-600 text-white text-xs font-semibold rounded-md hover:bg-gray-900 dark:bg-gray-200 dark:text-gray-800 dark:hover:bg-white transition-colors"
                        >
                            {copySuccess ? copySuccess : 'คัดลอกสคริปต์'}
                        </button>
                ...
                <div>
                    <h3 className="text-xl font-semibold border-b-2 border-green-500 pb-2 mb-4">ขั้นตอนที่ 3: ตั้งค่า Storage สำหรับรูปภาพโปรไฟล์</h3>
                    <p className="text-gray-600 dark:text-gray-400 mb-4">ขั้นตอนนี้จำเป็นเพื่อให้ฟังก์ชันอัปโหลดรูปโปรไฟล์ผู้ใช้งานทำงานได้</p>
                    <ol className="list-decimal list-inside text-gray-700 dark:text-gray-300 space-y-2">
                        <li>ไปที่หน้าโปรเจกต์ Supabase ของคุณ และเลือกเมนู <code className="bg-gray-200 dark:bg-gray-700 px-1.5 py-0.5 rounded">Storage</code> จากเมนูด้านซ้าย</li>
                        <li>คลิกที่ปุ่ม <code className="bg-gray-200 dark:bg-gray-700 px-1.5 py-0.5 rounded">+ Create a new bucket</code></li>
                        <li>ในช่อง Bucket name, กรอก: <code className="bg-gray-200 dark:bg-gray-700 px-1.5 py-0.5 rounded">avatars</code></li>
                        <li>ติ๊กที่ช่อง <code className="bg-gray-200 dark:bg-gray-700 px-1.5 py-0.5 rounded">This bucket is public</code> เพื่อให้ทุกคนสามารถดูรูปได้</li>
                        ...
                        <li>
                            ไปที่แท็บ <code className="bg-gray-200 dark:bg-gray-700 px-1.5 py-0.5 rounded">Policies</code> ของ bucket 'avatars' ที่เพิ่งสร้าง และคลิก <code className="bg-gray-200 dark:bg-gray-700 px-1.5 py-0.5 rounded">+ New Policy</code>
                            แล้วเลือก <code className="bg-gray-200 dark:bg-gray-700 px-1.5 py-0.5 rounded">Enable insert access for authenticated users</code> เพื่อให้ผู้ใช้ที่ล็อกอินแล้วสามารถอัปโหลดได้
                        </li>
                    </ol>
                </div>
            </div>
